...
const actionResolversMap = {
  Client: {
    ...
    createManyAndReturnClient:
      actionResolvers.CreateManyAndReturnClientResolver,
...
const modelsInfo = {
  Client: ["id", "email", "age", "kind", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  ClientAvgAggregate: ["age"],
  ClientSumAggregate: ["age"],
  ClientMinAggregate: [
    "id",
    "email",
    "age",
...
const inputsInfo = {
  ...
  ClientAvgOrderByAggregateInput: ["age"],
  ...
  ClientSumOrderByAggregateInput: ["age"],
  ...
  ClientCreateNestedOneWithoutPostsInput: [
    "create",
    "connectOrCreate",
    "connect",
  ],
  NullableStringFieldUpdateOperationsInput: ["set"],
  ClientUpdateOneRequiredWithoutPostsNestedInput: [
    "create",
    "connectOrCreate",
    "upsert",
    "connect",
  ...
  ClientUncheckedCreateWithoutPostsInput: [
    "id",
    "email",
    "age",
    "password",
  ...
  ClientUncheckedUpdateWithoutPostsInput: [
    "id",
    "email",
    "age",
    "password",
